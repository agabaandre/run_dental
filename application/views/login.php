...
<div class='box'>
  <div class='box-form'>
    ...
    <div class='box-login-title'>
      <div class=''></div><h2 style="color:#000000;">LOGIN </h2>
      
    </div>
    
    <div class='box-login'>
    <img src="<?php echo base_url(); ?>assets/img/logo.png" width="150" height="120">
    <p style="color:blue;"><?php if ($_POST['username']){echo $this->session->flashdata('message'); } ?></p>
...
<div class='icon-credits'> <a href="#" title="" target="_blank">Run Dental Clinic <?php echo date('Y');?></a></div>
