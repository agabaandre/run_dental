...
?>      <div class="nav-tabs-custom">
             <ul class="nav nav-tabs">
			      <li class="active"><a href="<?php echo base_url();?>Clinic/variables">System Variables</a></li>
 ...
 <hr style="border:1px solid rgb(140, 141, 137);"/>
  <div class="col-md-12">
	          <form method="post" action="<?php echo base_url();?>Clinic/variables" autocomplte="off">
                    <?php foreach($settings as $key=>$value):?>
	  	            <div id="">
					<label><?php echo strtoupper(str_replace("_"," ",$key)); ?></label>
                    <textarea class="form-control" name="<?php echo $key; ?>" style="width:100%;"><?php echo $value;?></textarea>
				   </div>
                   <?php endforeach; ?>
